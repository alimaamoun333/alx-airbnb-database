...
-- 2️⃣ Window Function: Rank properties by total number of bookings using ROW_NUMBER()
...
-- 3️⃣ Window Function: Rank properties by total number of bookings using RANK()
